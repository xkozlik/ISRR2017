...
Bio-chemists then decide if such a tunnel can be used to transport a given ligand mainly based on the tunnel lengths and its bottleneck (i.e.,
...
For a better decision, it is necessary to consider also the shape of the ligand and possibly also its flexibility.
...
The flexiblity of the ligand is modeled using a predefined set of typical conformations.
