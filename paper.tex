...
Moreover, it is not feasible to directly visualize and explore the resulting trajectories due the visual clutter (see Fig.~\ref{fig:trajectories} left) caused by their high number and close proximity.
...
In order to do that, we employ an ensemble of resulting trajectories in order to compute and visualize the following tunnel properties:
\begin{itemize}
