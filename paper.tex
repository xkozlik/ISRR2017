...
The RRT planner is extended by guided sampling, scaling of the ligands atoms and using predefined set of ligand conformations.
...
The path $P=(q_i), q_i \in \C$ is represented as a sequence of the collision-free configurations.
