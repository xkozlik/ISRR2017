...
%Traversability of ligands with more atoms 
%It is not easy to o estimate traversability of the tunnel for a ligand with more atoms.
...
%which can be formulated as a path planning problem in the a high-dimensional configuration space.
