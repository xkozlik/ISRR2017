...
%However, from a static snapshot it is hard to assess the biochemical relevance of the tunnel as it does not provide information about its temporal stability. 
...
To utilize a knowledge about the environment in the sampling process, 
   %represented e.g. using a mexial axis or a 2D or 3D path,
